...
typedef struct vectork vectork;
...
kissat_begin_vector (vectors * vectors, vectork * vector)
{
  return BEGIN_STACK (vectors->stack) + vector->offset;
}

static inline unsigned *
kissat_end_vector (vectors * vectors, vectork * vector)
{
...
static inline unsigned *
kissat_last_vector_pointer (vectors * vectors, vectork * vector)
{
  assert (vector->size);
...
static inline void
kissat_pop_vector (vectors * vectors, vectork * vector)
{
...
unsigned *kissat_enlarge_vector (struct kissat *, vectors *, vectork *);
void kissat_defrag_vectors (struct kissat *, vectors *, unsigned, vectork *);
void kissat_remove_from_vector (struct kissat *, vectors *, vectork *,
				unsigned);
void kissat_resize_vector (struct kissat *, vectors *, vectork *, sector);
void kissat_release_vector (struct kissat *, vectors *, vectork *);
...
kissat_push_vectors (struct kissat *solver,
		     vectors * vectors, vectork * vector, unsigned e)
{

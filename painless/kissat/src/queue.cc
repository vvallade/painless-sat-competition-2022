...
void
kissat_init_queue (queuek * queue)
{
...
static void
reassign_queue_stamps (kissat * solver, links * links, queuek * queue)
{
...
static inline void
enqueue (kissat * solver, unsigned i, links * links, queuek * queue)
{
...
static inline void
dequeue (unsigned i, links * links, queuek * queue)
{

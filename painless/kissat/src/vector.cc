...
unsigned *
kissat_enlarge_vector(kissat *solver, vectors *vectors, vectork *vector)
{
...
rank_offset(vectork *unsorted, unsigned i)
{
...
void kissat_defrag_vectors(kissat *solver, vectors *vectors,
                           unsigned size_unsorted, vectork *unsorted)
{
  START(defrag);
  unsigneds *stack = &vectors->stack;
...
void kissat_remove_from_vector(kissat *solver,
                               vectors *vectors, vectork *vector,
                               unsigned remove)
{
...
void kissat_resize_vector(kissat *solver, vectors *vectors, vectork *vector,
                          sector new_size)
{
...
void kissat_release_vector(kissat *solver, vectors *vectors, vectork *vector)
{
...
void kissat_check_vector(vectors *vectors, vectork *vector)
{
